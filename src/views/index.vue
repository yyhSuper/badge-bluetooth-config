            ...
            <div class="list-item">
              <div class="list-item-body">
                <div class="list-item-body-item" v-for="(item,index) in otherList" :key="index">
                  <div class="item-label">Chinanet-001</div>
                  <div class="list-item-button-wrap">
                    <el-input placeholder="请输入WiFi密码" size="mini" class="input-item"   :disabled="!isConnect"></el-input>
        ...
        <el-card class="box-card">
          <el-form >
            <el-form-item label="IP Address：">
             <el-input placeholder="Please enter the IP address" v-model="SaaSForm.ip"   :disabled="!isConnect"></el-input>
            </el-form-item>
            <el-form-item label="Port：">
              <el-input placeholder="Please enter the port number" v-model="SaaSForm.port"   :disabled="!isConnect"></el-input>
            </el-form-item>
          </el-form>
        </el-card>
        <div class="title-wrap">
        ...
        <el-card class="box-card">
          <div class="warning-wrap">
            ...
            <div class="warning-wrap-button-wrap">
              <el-button size="mini" type="danger"   :disabled="!isConnect">I have read the warning and I want to restore the menu</el-button>
            </div>
          </div>
